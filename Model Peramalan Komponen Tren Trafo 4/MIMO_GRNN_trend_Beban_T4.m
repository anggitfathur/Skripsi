...
for i = 1:numRows
    MIMO_input_data(i, :) = standardized_trend(i:i+(numCol-1))';
...
Destandardized_prediction1 = prediction_detransform1 * std_dev_trend_component + mean_trend_component; 
Destandardized_prediction2 = prediction_detransform2 * std_dev_trend_component + mean_trend_component;
Destandardized_prediction3 = prediction_detransform3 * std_dev_trend_component + mean_trend_component;
...
% Update best model
best_maPe = MAPE;
MIMO_GRNN_Beban_T4_best_net = grnn_model;
...
grid on;
clear grnn_model;
Prediction_Beban = Destandardized_prediction;
...
%Save Best model
save('GRNN_TSF_Beban_Direct_MIMO_trafo4.mat', 'MIMO_GRNN_Beban_T4_best_net');
save('Prediction_Result_Trend_Beban_GRNN_T4.mat', 'Prediction_Beban');
save('matrix_data_GRNN_MIMO_Beban_T4.mat', 'MIMO_input_data');
save('best_combination_GRNN_Beban_T4.mat','best_combination'); 
save('combinations_matrix_Beban_T4_GRNN_MIMO.mat.mat','best_combination'); 
save('absolute_errors_matrix_Beban_T4_BPNN_MIMO.mat', 'absolute_errors_matrix')
save('absolute_errors_percentage_matrix_Beban_T4_BPNN_MIMO.mat', 'absolute_percentage_errors_matrix')