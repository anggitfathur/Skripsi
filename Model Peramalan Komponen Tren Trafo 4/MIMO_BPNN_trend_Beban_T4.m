...
if MAPE < best_mape
    ...
    best_mape = MAPE;
    MIMO_BPNN_Trend_Beban_T4_best_net = net;
    best_mae = MAE;
...
Prediction_Beban = [Destandardized_prediction1',Destandardized_prediction2', Destandardized_prediction3'];
...
% Save the best model
save('BPNN_TSF_Direct_MIMO_Beban_T4.mat', 'MIMO_BPNN_Trend_Beban_T4_best_net');
...
save('Prediction_Result_Trend_Beban_BPNN_T4.mat', 'Prediction_Beban')
save('best_combination_MIMO_BPNN_trafo4.mat', 'best_combination'); 
save('combinations_matrix_Beban_T4_BPNN_MIMO.mat', 'combinations_matrix')
