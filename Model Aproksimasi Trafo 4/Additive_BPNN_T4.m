...
load('Prediction_Result_Trend_Beban_BPNN_T4.mat');
load('Prediction_Result_PDRB_BPNN_T4.mat');
load('Prediction_Result_Industri_BPNN_T4.mat');
...
momentums = (0.74:0.05:0.9);  % Adjust the momentum values to your needs
neuron = (6:2:12);  % Adjust the hidden layer sizes to your needs
epochs = (1100:200:1500);  % Adjust the epoch values to your needs
neuron2= (6:2:12); 
num_hidden = (1:1:2);
...
% Save the best model
save('FA_BPNN_T4(b).mat', 'FA_BPNN_T4_best_net');
...
save('best_combination_FA_BPNN_T4(a).mat', 'best_combination'); 
save('combinations_matrix_FA_BPNN_4(a).mat', 'combinations_matrix')
save('absolute_errors_matrix_FA_BPNN_T4(a).mat', 'absolute_errors_matrix')
save('absolute_errors_matrix_FA_BPNN_T4(a).mat', 'absolute_errors_matrix')
save('Prediction_FA_BPNN_T4(a).mat', 'Prediction');
