...
load('GRNN_TSF_Beban_Direct_MIMO_trafo4.mat');;
...
for i = 1:numIterations
    ...
    forecast = sim(MIMO_GRNN_Beban_T4_best_net, DataForecast_transform); 
    ...
    Result_forecast_trend (:, i) = destandardized_forecast(12); 
...
save('Result_forecast_MIMO_GRNN_Trend_Beban_T4.mat', 'Result_forecast_trend')