...
for i = 1:numRows
    data(i, :) = standardized_PDRB(i:i+104)';
...
Destandardized_prediction1 = predicted_detransform1 * std_dev_PDRB + mean_PDRB; 
Destandardized_prediction2 = predicted_detransform2 * std_dev_PDRB + mean_PDRB;
Destandardized_prediction3 = predicted_detransform3 * std_dev_PDRB + mean_PDRB;
...
if MAPE < best_mape
    ...
    best_mape = MAPE;
    MIMO_BPNN_PDRB_T4_best_net = net;
    best_mae = MAE;
...
Prediction_PDRB = [Destandardized_prediction1',Destandardized_prediction2', Destandardized_prediction3'];
...
% Save the best model
save('BPNN_TSF_Direct_MIMO_PDRB_T4.mat', 'MIMO_BPNN_PDRB_T4_best_net');
...
save('Prediction_Result_PDRB_BPNN_T4.mat', 'Prediction_PDRB')
save('best_combination_PDRB_MIMO_BPNN_trafo4.mat', 'best_combination'); 
save('combinations_matrix_PDRB_T4_BPNN_MIMO.mat', 'combinations_matrix')
