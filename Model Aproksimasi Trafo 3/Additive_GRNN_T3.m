...
load('Prediction_Result_Trend_GRNN_T3.mat');
...
spreadparameter = 0.1:0.1:1.5; %range spreadparameter
...
for i = 1:length(spreadparameter)
    ...
    % Update best model
    best_maPe = MAPE;
    FA_GRNN_T3_best_net = grnn_model;
    ...
    save('FA_GRNN_T3.mat', 'FA_GRNN_T3_best_net');
...
%Save Best model
save('Prediction_FA_GRNN_T3.mat', 'Prediction');
save('best_combination_FA_GRNN_T3.mat', 'best_combination'); 
save('combinations_matrix_FA_GRNN_T3.mat', 'combinations_matrix')
save('absolute_errors_matrix_FA_GRNN_T3.mat', 'absolute_errors_matrix')
save('absolute_errors_matrix_FA_GRNN_T3.mat', 'absolute_errors_matrix')